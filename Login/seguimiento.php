...
<div class="input-group mb-12 col-md-12" style="text-align: right;">
    <a href="index.php" class="btn btn-default" style="box-shadow: 0 0 0 .2rem rgba(0,0,0,0);">Regresar al
        login</a><br><br>
</div>
...
<body>
    <div style="text-align: center;" class="row">
        ...
        <div class="col-md-1">
            <button class="btn btn-primary" onclick="buscardocumento()"><i
                    class=" fa fa-plus-square-o"></i>&nbsp;BUSCAR</button> <br><br>
        </div>
    </div>
    <div class="main-w3ls">
        <div class="left-content" style="text-align: center;flex: 0 0 100%;max-width: 100%;">
            <div class="center-content form-style-agile" id="divpadre">
                <div class="input-group mb-12 col-md-12" id="divhijo">
                    <table id="tabla_horario" class="table table-condensed jambo_table">
                        <thead>
                            <tr>
                                <th style='text-align: center;width: 80px;word-wrap: break-word;font-weight: bold;'>ID
                                </th>
                                <th style='text-align: center;width: 50px;word-wrap: break-word;font-weight: bold;'>
                                    ASUNTO</th>
                                <th style='text-align: center;width: 130px;word-wrap: break-word;font-weight: bold;'>
                                    FECHA RECEPCI&OacuteN</th>
                                <th style='text-align: center;width: 150px;word-wrap: break-word;font-weight: bold;'>
                                    &Aacute;REA ASIGNADA</th>
                                <th style='text-align: center;width: 150px;word-wrap: break-word;font-weight: bold;'>
                                    TIPO DOCUMENTO</th>
                                <th style='text-align: center;width: 40px;word-wrap: break-word;font-weight: bold;'>
                                    REMITENTE</th>
                                <th style='text-align: center;width: 20px;word-wrap: break-word;font-weight: bold;'>
                                    ARCHIVO</th>
                                <th style='text-align: center;width: 30px;word-wrap: break-word;font-weight: bold;'>
                                    ESTADO</th>
                            </tr>
                        </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><b>Asunto del Documento Nro: </b><label
                            id="txtiddocumento_modal"></label></h4>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" rows="8" style="resize: none" readonly=""
                                style="color: rgb(25,25,51); background-color: rgb(255,255,255);solid 5px;"
                                placeholder="Ingresar Asunto ..." id="txtasunto_documento_modal"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                            class="fa fa-close"></i>&nbsp;<b>Close</b></button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="modal_datos_remitente_documento_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><b>Datos del Remitente del Documento Nro: </b><label
                            id="txtiddocumento1_modal"></label></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade bs-example-modal-lg" id="modal_archivo_documento" role="dialog"
        aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><b>ARCHIVO DEL DOCUMENTO: </b><label
                            id="txtiddocumento1_modal"></label></h4>
                    <div class="kv-zoom-actions pull-right">
                        <button type="button" class="btn btn-default btn-close" title="Close detailed preview"
